...
export const PAGE_SEO = {
  ...
  weather: {
    ...
    title: "Clima",
    description:
      "Clima en Santo Domingo, Santiago, Punta Cana y otras ciudades de República Dominicana. Temperatura, condición y probabilidad de lluvia.",
    keywords: [
      "clima RD",
      "clima Santo Domingo",
      "pronóstico",
  ...
  privacy: {
    ...
    description:
      "Cómo RD Al Día trata datos, cookies, analítica y anuncios de Google AdSense. Derechos de las personas usuarias.",
