...
export const DEFAULT_DESCRIPTION =
  "RD Al Día: titulares dominicanos, precio del combustible, tasa del dólar, clima en 10 ciudades, LIDOM y MLB. Lo que importa hoy en República Dominicana, al día.";
...
export const PAGE_SEO = {
  ...
  weather: {
    ...
    title: "Clima",
    description:
      "Clima en Santo Domingo, Santiago, Punta Cana y otras ciudades de República Dominicana. Temperaturas, lluvia y mapa de viento.",
    keywords: [
      "clima RD",
      "clima Santo Domingo",
      "pronóstico",
  ...
  advertise: {
    ...
    title: "Anúnciate",
    description:
      "Publicidad en RD Al Día: leaderboard, rectangle y mobile banner frente a lectores de República Dominicana. Combustible, dólar, noticias y deportes.",
    keywords: ["publicidad", "anuncios", "AdSense", "medios RD"],
  ...
  about: {
    ...
    title: "Acerca de",
    description:
      "Qué es RD Al Día: el hub diario de República Dominicana para combustible, dólar, clima, béisbol, titulares, cultura y turismo.",
  ...
  contact: {
    ...
    title: "Contacto",
    description:
      "Escríbenos: correcciones, alianzas, publicidad o ideas para RD Al Día. Respondemos desde Santo Domingo.",
  ...
  privacy: {
    ...
    description:
      "Cómo RD Al Día cuida tu información: mensajes, boletín, medición de visitas y anuncios. Cómo pedirnos que borremos tus datos.",
    keywords: ["privacidad", "cookies", "AdSense", "datos personales"],
