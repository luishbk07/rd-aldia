...
import { articleSeoDescription, clipSeoDescription } from "./description";
...
export function pageMetadata(entry, extra = {}) {
  ...
  const rawDescription = extra.description || entry.description;
  const description = extra.articleExcerpt
    ? articleSeoDescription(rawDescription)
    : clipSeoDescription(rawDescription);
